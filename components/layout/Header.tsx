...
import { UserIcon, LogoIcon, MenuIcon, XIcon, InformationCircleIcon, ChevronDownIcon } from '../Icons';
                        ...
                        {isAdminDropdownOpen && (
                            <div className={dropdownContainerClass}>
                                ...
                                <NavLink to="/admin" onClick={() => setIsAdminDropdownOpen(false)} className={dropdownItemClass}>
                                    {user.role === 'superadmin' ? 'Areas & Administrators' : 'My Areas'}
                                </NavLink>
                            </div>
                        )}
                  </div>
                ...
                <div className="relative h-full flex items-center" ref={accountDropdownRef}>
                    ...
                    {isAccountDropdownOpen && (
                        <div className={`${dropdownContainerClass} right-0 left-auto`}>
                            ...
                            <button onClick={handleSettingsClick} className={dropdownItemClass}>
                                Profile Settings
                            </button>
                ...
                {(user.role === 'admin' || user.role === 'superadmin') && (
                  <>
                    ...
                    <NavLink to="/admin" target="_self" className={mobileLinkClass} onClick={() => setIsMenuOpen(false)}>
                      {user.role === 'superadmin' ? 'Areas & Admins' : 'Areas'}
                    </NavLink>
                  </>
                )}
