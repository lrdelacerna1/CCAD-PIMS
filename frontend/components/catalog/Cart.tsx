        ...
        <div className="bg-white dark:bg-slate-800 p-4 rounded-t-lg shadow-lg flex flex-col h-full border-t border-x dark:border-slate-700 lg:border-r lg:border-t-0 lg:border-x-0 lg:rounded-none">
            ...
            <div className="flex-grow overflow-y-auto min-h-0 space-y-4 pr-1">
                ...
                <div className="pt-3 border-t dark:border-slate-700">
                    <h3 className="text-xl font-semibold dark:text-white mb-3">Request Cart</h3>

                    {totalItemCount === 0 ? (
                        <div className="flex items-center justify-center py-8 bg-slate-50 dark:bg-slate-900/50 rounded-lg">
