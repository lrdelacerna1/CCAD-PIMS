...
// FIX: Accept a `title` prop for accessibility.
...
export const GoogleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" {...props}>
    ...
    <path fill="#4CAF50" d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.211 35.091 26.715 36 24 36c-5.222 0-9.618-3.226-11.283-7.582l-6.522 5.025C9.505 39.556 16.227 44 24 44z"/>
...
export const CalendarPlusIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 12.75h.008v.008H12v-.008zM12 9h.008v.008H12V9zm-2.25 3.75h.008v.008H9.75v-.008zm0-3.75h.008v.008H9.75V9zm4.5 3.75h.008v.008H14.25v-.008zm0-3.75h.008v.008H14.25V9z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-2.25m-2.25 1.125h4.5" transform="translate(0, 2)"/>
  </svg>
);
...
export const CalendarDaysIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M9.75 12.75h.008v.008H9.75v-.008zm0 3h.008v.008H9.75v-.008zm3-3h.008v.008H12.75v-.008zm3 0h.008v.008H15.75v-.008zm-3 3h.008v.008H12.75v-.008zm3 0h.008v.008H15.75v-.008z" />
  </svg>
);
...
export const UserGroupIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-8.262 9.337 9.337 0 00-4.121-8.262 9.38 9.38 0 00-2.625.372M15 19.128v-3.857M15 19.128c-3.128 0-5.128-3.128-5.128-3.128s-2 3.128-5.128 3.128M15 5.25v-3.857M15 5.25c-3.128 0-5.128-3.128-5.128-3.128s-2 3.128-5.128 3.128" />
    </svg>
);

// FIX: Accept a `title` prop for accessibility.
export const BriefcaseIcon: React.FC<React.SVGProps<SVGSVGElement> & { title?: string }> = ({ title, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    {title && <title>{title}</title>}
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.07a2.25 2.25 0 01-2.25 2.25H5.97a2.25 2.25 0 01-2.25-2.25v-4.07a2.25 2.25 0 012.25-2.25h12.13a2.25 2.25 0 012.12 1.635l.07.365a2.25 2.25 0 002.12-1.635V6.73a2.25 2.25 0 00-2.25-2.25H5.97a2.25 2.25 0 00-2.25 2.25v4.07a2.25 2.25 0 002.25 2.25h12.13a2.25 2.25 0 002.12-1.635l.07-.365a2.25 2.25 0 012.12 1.635z" />
  </svg>
);

// FIX: Accept a `title` prop for accessibility.
export const AcademicCapIcon: React.FC<React.SVGProps<SVGSVGElement> & { title?: string }> = ({ title, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    {title && <title>{title}</title>}
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-2.072-1.036A3.375 3.375 0 012.625 6.162l1.012 2.024M12 10.147l4.247 2.124M12 10.147l-4.247 2.124M12 10.147v4.498m0 0l4.247 2.124m-4.247-2.124l-4.247 2.124" />
  </svg>
);
